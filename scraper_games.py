...
def run_scorer_scraper(json_data, soup, url):
    ...
    for team_type in ['home', 'away']:
        ...
        # Define file paths
        if team_type == 'home':
            list_players_csv = r'C:\Users\axel_\Documents\conda\random-games\goals\csv\listHomePlayers.csv'
            scorers_csv = r'C:\Users\axel_\Documents\conda\random-games\goals\csv\homeScorers.csv'
        else:
            list_players_csv = r'C:\Users\axel_\Documents\conda\random-games\goals\csv\listAwayPlayers.csv'
            scorers_csv = r'C:\Users\axel_\Documents\conda\random-games\goals\csv\awayScorers.csv'
...
def run_match_stats_scraper(json_data, soup, url):
    ...
    try:
        ...
        # Save to CSV
        csv_filename = r'C:\Users\axel_\Documents\conda\random-games\matchStats\csv\fotmob_match_stats.csv'
...
def run_player_stats_scraper(json_data, soup, url):
    ...
    try:
        ...
        csv_directory = r'C:\Users\axel_\Documents\conda\random-games\playerStats\csv\\'
...
def run_shots_scraper(json_data, soup, url):
    ...
    try:
        ...
        # Save to CSV
        match_name = extract_match_name_from_url(url)
        csv_directory = r'C:\Users\axel_\Documents\conda\random-games\shots\csv\\'
        os.makedirs(csv_directory, exist_ok=True)
